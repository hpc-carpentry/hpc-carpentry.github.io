...
If you are a for-profit institution please [contact us](mailto: team@carpentries.org). 50% of workshop coordination fees for for-profit institutions support workshops in diverse communities.
...
If you need to postpone your workshop please contact the  [Regional Coordinator](https://carpentries.org/regionalcoordinators/). They will work with you to select the dates for the rescheduled workshop. 
...
Instructors are required to teach at least one time per year to be eligible for voting. Please see our [Bylaws](https://docs.carpentries.org/topic_folders/governance/bylaws.html#individual-voting-membership) for more information. 
